...
public class DateUtils { // repeat inventing the wheels - reiz
  ...
  public static final String DATE_PATTEN_HM = "HH:mm";
  public static final String DATE_PATTEN_MDHM = "MM-dd HH:mm";
  ...
  private static final SimpleDateFormat HM = new SimpleDateFormat(DATE_PATTEN_HM);
  private static final SimpleDateFormat MDHM = new SimpleDateFormat(DATE_PATTEN_MDHM);
    ...
    formatterCache.put(DATE_PATTEN_HM, HM);
    formatterCache.put(DATE_PATTEN_MDHM, MDHM);
	}
  ...
  public static String formatDateHM(Date date) {
    return DateUtils.formatDate(DATE_PATTEN_HM,date);
  }

  public static Date parseDateHM(String dateString) {
    return DateUtils.parseDate(DATE_PATTEN_HM,dateString);
  }

  public static String formatDateMDHM(Date date) {
    return DateUtils.formatDate(DATE_PATTEN_MDHM,date);
  }

  public static Date parseDateMDHM(String dateString) {
    return DateUtils.parseDate(DATE_PATTEN_MDHM,dateString);
  }
